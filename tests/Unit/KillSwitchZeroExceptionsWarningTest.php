...
final class KillSwitchZeroExceptionsWarningTest extends TestCase {
	...
	/**
	 * AC: kill off → no zero-exceptions warning; existing not-in-effect messaging unchanged.
	 */
	public function test_kill_off_keeps_not_in_effect_and_hides_warning(): void {
		...
		$this->assertStringContainsString( 'Not in effect while the kill switch is off.', $html );
		$this->assertMatchesRegularExpression(
