	...
	public static function highlights_catalog(): array {
		return array(
			'1.5.0' => array(
				...
				__( 'Get one alert the first time a plugin uses a new AI provider. You can also alert on new models. The first recorded call sets a baseline and does not send an alert.', 'handl-ai-connector-access-control' ),
