...
* Optional why notes on plugin rules (Rules table, plugin profile, Activity, CSV, and printable evidence). Notes stay on the site, clear when a rule is removed, and round-trip through rules export/import.
