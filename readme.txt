...
= Unreleased =
* On Activity settings, see how much space the activity log uses and plain-language estimates for shorter retention times. A suggested limit fills the field only — nothing changes until you save.
