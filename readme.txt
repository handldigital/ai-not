...
* Insights daily trend lines for calls, estimated spend, and blocked calls over up to 30 days from saved Activity, with honest short-window labels and a per-plugin expand on the Plugins table.
