...
* Editors who hit a blocked AI Client call can request temporary access; the site owner gets one email per plugin per day with approve (24-hour allow) or deny links, and pending requests appear on Protections.
