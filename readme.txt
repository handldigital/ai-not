...
= Unreleased =
* Mute alerts for one plugin for 1 hour, 8 hours, 24 hours, or 7 days. Denials still log and rules still enforce; when the mute ends you get a count of alerts that would have been sent.
