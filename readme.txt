...
* Optional weekly governance digest email: last 7 days of AI Client calls, estimated spend vs the prior week, blocked calls, direct connections, usage spike alerts, and top plugins. Off by default.
